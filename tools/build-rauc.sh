...
IMAGETYPES=("production" "development")
...
printf "\n\n"
printf "BUILDING DEVICE RAUC UPDATE BUNDLE\n"
printf "==================================\n\n"
...
#MACHINE="${MACHINE}" WIF="${WIF}" bitbake -R ${POSTCONF} -k ${IMAGE}${IMAGETYPE}-rauc-sd
MACHINE="${MACHINE}" WIF="${WIF}" bitbake -R ${POSTCONF} -k ${IMAGE}${IMAGETYPE}-rauc-emmc
